...
from JLatorreASaravia import views

from django.urls import path
from JLatorreASaravia.views import LoginView

urlpatterns = [
    path('admin/', admin.site.urls),
    path('Listado_Compras/', views.VistaCompras, name='Listado'),
    path('autor/', views.Autor, name='autor'),
    path('Agregar', views.Formulario, name='Formulario'),
    ...
    path('', views.Menu, name='MenuInicio'),
